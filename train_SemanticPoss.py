...
# ----------------------------------------------------------------------------------------------------------------------
#
#      Callable script to start a training on SemanticPoss dataset
#
# ----------------------------------------------------------------------------------------------------------------------
#
...
class SemanticPossConfig(Config):
    """
...
if __name__ == '__main__':
    ...
    # Initialize datasets
    training_dataset = SemanticPossDataset(config, set='training',
                                            balance_classes=True)
    test_dataset = SemanticPossDataset(config, set='validation',
                                        balance_classes=False)

    # Initialize samplers
    training_sampler = SemanticPossSampler(training_dataset)

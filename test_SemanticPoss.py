...
# Dataset
from datasets.SemanticPoss import *
...
if __name__ == '__main__':
    ...
    # chosen_log = 'results/pretrain_true_frame_4_epoch_400_bsz_32_lr_1e-2'  # => ModelNet40
    chosen_log = 'results/pretrain_false_frame_4_epoch_300_bsz_16_lr_1e-3'
    ...
    config.stride = 1
    config.first_subsampling_dl = 0.060
    ...
    elif config.dataset == 'SemanticPoss':
        test_dataset = SemanticPossDataset(config, set=set, balance_classes=False, seqential_batch=True)
        test_sampler = SemanticPossSampler(test_dataset)
        collate_fn = SemanticPossCollate
    else:
